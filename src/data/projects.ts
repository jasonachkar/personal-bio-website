...
export const projects: Project[] = [
  ...
  },
  {
    ...
    category: 'cyber',
    description:
      'CIS Benchmark-aligned security hardening guide for Azure environments. Covers identity management, network security, encryption, logging, compliance, and automated verification scripts for continuous posture checks.',
