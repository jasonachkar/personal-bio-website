export const aboutCopy = {
  title: 'Platform & DevSecOps engineer building secure systems from the ground up.',
  paragraphs: [
  ...
  coreStrengths: [
    {
      ...
      description: 'Securing developer platforms, pipeline policies, and access governance at scale',
    },
    {
      title: 'Secure CI/CD',
      description: 'Build gates with SAST, DAST, secrets scanning, SCA, and IaC validation',
    },
    {
      title: 'Cloud Architecture',
      description: 'Azure defense-in-depth: Key Vault, Managed Identities, private networking, RBAC',
    },
    {
      title: 'Security Engineering',
      description: 'Threat modeling, secure SDLC, OWASP/CWE mitigations, least privilege',
    },
    {
      title: 'IaC Automation',
      description: 'Terraform, HCL static analysis, ephemeral sandboxed runners, config governance',
    },
    {
      title: 'SaaS Product Development',
      description: 'Solo-built production multi-tenant security SaaS with defense-in-depth architecture',
    },
  ],
};
