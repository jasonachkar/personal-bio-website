...
export const projects: Project[] = [
  {
    ...
    featured: true,
    description:
      'Deployed, multi-tenant DevSecOps SaaS that unifies seven open-source security scanners into a centralized triage and enforcement platform: normalized findings, cross-tool correlation, CI/CD build gates, pull-request feedback, and Terraform-based Azure attack-path analysis.',
    tech: ['.NET 8', 'Angular 21', 'PostgreSQL 16', 'Azure', 'Terraform', 'Docker', 'Entra ID', 'SARIF'],
    role: 'Founder & Security Engineer — architecture, detection logic, and platform',
    demoUrl: 'https://www.secureobs.com',
    thumbnail: '/thumbnails/secureobs.jpg',
  },
  {
    ...
    category: 'cyber',
    description:
      'IaC implementation of an Azure landing zone with security best practices: network segmentation, Azure Policy enforcement, RBAC, centralized Log Analytics, and compliance monitoring.',
  ...
  },
  {
    ...
    category: 'cyber',
    description:
      'KQL-based detection rules for Azure Sentinel targeting suspicious auth, privilege escalation, lateral movement, and data exfiltration — all mapped to MITRE ATT&CK.',
  ...
  },
  {
    ...
    category: 'cyber',
    description:
      'Reference CI/CD pipeline with integrated SAST (SonarQube), dependency vulnerability checks, container scanning (Trivy), IaC security validation, and automated security testing gates.',
  ...
  },
  {
    ...
    category: 'cyber',
    description:
      'Production-ready API gateway with JWT auth, rate limiting, request validation, SQLi/XSS protection, and comprehensive logging. Full OWASP API Top 10 mitigations.',
  ...
  },
  {
    ...
    category: 'cyber',
    description:
      'Full STRIDE threat model for a multi-tenant CRM: data flow diagrams, trust boundaries, threat identification, risk scoring, and prioritized mitigation guidance.',
